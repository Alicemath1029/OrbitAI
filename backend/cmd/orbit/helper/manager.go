...
import (
	...
	aisystemv1alpha1 "github.com/raids-lab/orbit/pkg/apis/aijob/v1alpha1"
	recommenddljob "github.com/raids-lab/orbit/pkg/apis/recommenddljob/v1"
	...
	"github.com/raids-lab/orbit/pkg/reconciler"
...
func (ms *ManagerSetup) CreateCRDManager() (manager.Manager, error) {
	...
	options := ctrl.Options{
		...
		LeaderElectionID:       "0566f233.orbit.raids-lab.github.io",
	}
