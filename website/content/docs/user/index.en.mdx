...
The platform uses intelligent resource scheduling algorithms to automatically assign the optimal resources to jobs based on factors such as job priority and resource requirements. For example, when multiple jobs simultaneously request resources, Orbit can quickly analyze and allocate resources to the most urgent and critical tasks, improving overall execution efficiency.
...
<Cards>
  <Card href="/en/docs/user/quick-start/login" title="Platform Access">
    Learn how to access the Orbit platform within the laboratory
  </Card>
