...
Jupyter 상호작용형 페이지에서 Orbit 아이콘의 플로팅 볼을 찾습니다:

![alt text](./img/floatball.png)

이미지 저장을 클릭하고 확인합니다.

Orbit 플랫폼은 사용자를 이미지 제작 페이지로 리디렉션합니다. 여기서 이미지 패키징 작업의 구체적인 진행 상황을 확인할 수 있습니다. 성공 후, 이미지 선택 시 `Snapshot of XXXX`로 설명된 이미지를 볼 수 있습니다.
