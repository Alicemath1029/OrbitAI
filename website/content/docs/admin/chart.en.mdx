...
description: "Detailed explanation of Orbit platform Helm Chart configuration parameters, covering core modules such as backend, frontend, storage, monitoring, and authentication."
---

<ChartBadge />

Orbit is a comprehensive AI development platform designed for Kubernetes, providing GPU resource management, containerized development environments, and workflow orchestration. This document details all configurable items when deploying Orbit via Helm.

**Project Homepage:** [https://github.com/raids-lab/orbit](https://github.com/raids-lab/orbit)
...
* [https://github.com/raids-lab/orbit/tree/main/charts/orbit](https://github.com/raids-lab/orbit/tree/main/charts/orbit)

## Global Values

| Parameter | Type | Default | Description |
|-----|------|---------|-------------|
| host | string | `"orbit.example.com"` | Domain name or IP address for platform access |
| protocol | string | `"http"` | Protocol type (`http` or `https`) |
| firstUser.username | string | `"orbit-admin"` | Initial administrator username |
...
| namespaces.job | string | `"orbit-workspace"` | Namespace for running job tasks |
...
| storage.pvcName | string | `"orbit-rw-storage"` | Name of the shared PVC |
...
| Parameter | Type | Default | Description |
|-----|------|---------|-------------|
| backendConfig.secrets.tlsSecretName | string | `"orbit-tls-secret"` | Name of the TLS certificate Secret for HTTPS |
| backendConfig.secrets.tlsForwardSecretName | string | `"orbit-tls-forward-secret"` | Name of the TLS certificate Secret for forwarding |
