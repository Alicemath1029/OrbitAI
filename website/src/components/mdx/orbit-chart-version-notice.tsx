...
import { getChartVersion, isChartVersionInjected, CHART_YAML_URL } from '@/lib/orbit-version';
...
/**
 * Renders information about the Orbit Helm Chart version and its
 * requirement for image version consistency.
 */
export function OrbitChartVersionNotice() {
  const t = useTranslations('OrbitChartVersionNotice');
